...
public class CreamsAndSoapsActivity extends AppCompatActivity {
    EditText itemName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_creams_and_soaps);
        listView = (ListView) findViewById(R.id.list);
        setListViewHeader();
        setListViewAdapter();
        createProductListSoaps();
        createProductListCreams();
    ...
    private void createProductListCreams() {
        myItems.add(new Items(R.drawable.cream1, "RoSe", "100"));
        myItems.add(new Items(R.drawable.cream2, "NiO","50"));
        myItems.add(new Items(R.drawable.cream3, "Nevia", "20"));
        myItems.add(new Items(R.drawable.cream4, "Fair&Lovely", "200"));
        myItems.add(new Items(R.drawable.cream5, "Pantos", "150"));
