...
public class BladesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_blades);
        listView = (ListView) findViewById(R.id.list);
        setListViewHeader();
        setListViewAdapter();
        createProductListBlades();
    ...
    private void createProductListBlades() {
        myItems.add(new Items(R.drawable.blade1, "Zila", "100"));
        myItems.add(new Items(R.drawable.blade2, "Carirides","50"));
        myItems.add(new Items(R.drawable.blade3, "Gillette", "70"));
        myItems.add(new Items(R.drawable.blade4, "Notallade", "65"));
        myItems.add(new Items(R.drawable.blade5, "Men's Blade", "90"));
