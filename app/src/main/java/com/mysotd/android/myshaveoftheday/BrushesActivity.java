...
public class BrushesActivity extends AppCompatActivity {
    ...
    private void createProductListBrushes() {
        myItems.add(new Items(R.drawable.brush1, "Velivo", "100"));
        myItems.add(new Items(R.drawable.brush2, "CeLLa","50"));
        myItems.add(new Items(R.drawable.brush3, "R.Mountain", "60"));
        myItems.add(new Items(R.drawable.brush4, "Star", "200"));
        myItems.add(new Items(R.drawable.brush5, "Cyllia", "30"));
