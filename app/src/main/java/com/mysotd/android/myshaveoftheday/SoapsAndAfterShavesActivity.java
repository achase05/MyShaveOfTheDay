...
public class SoapsAndAfterShavesActivity extends AppCompatActivity {
    EditText itemName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soaps_and_after_shaves);
        listView = (ListView) findViewById(R.id.list);
        setListViewHeader();
        setListViewAdapter();
        createProductListSoaps();
        createProductListAfterShaves();
    ...
    private void createProductListAfterShaves() {
        myItems.add(new Items(R.drawable.as1, "DieseLL", "100"));
        myItems.add(new Items(R.drawable.as2, "SimpSon","50"));
        myItems.add(new Items(R.drawable.as3, "Ajas", "60"));
        myItems.add(new Items(R.drawable.as4, "JooP && JooP", "55"));
        myItems.add(new Items(R.drawable.as5, "Loreal", "30"));
        myItems.add(new Items(R.drawable.as6, "ProSmart", "70"));
        myItems.add(new Items(R.drawable.as7, "LandsPro", "20"));
        myItems.add(new Items(R.drawable.as8, "PearLs", "50"));
        myItems.add(new Items(R.drawable.as9, "I.Ivory", "35"));
        myItems.add(new Items(R.drawable.as10, "Viveal", "200"));
        myItems.add(new Items(R.drawable.as11, "Olive", "250"));
        myItems.add(new Items(R.drawable.as12, "Spa AfterShave", "10"));
        adapter.notifyDataSetChanged();
    }
    private void createProductListSoaps() {
        myItems.add(new Items(R.drawable.soap1, "ArKo", "100"));
        myItems.add(new Items(R.drawable.soap2, "CeLLa","50"));
        myItems.add(new Items(R.drawable.soap3, "R.Mountain", "60"));
        myItems.add(new Items(R.drawable.soap4, "MccOTES", "55"));
        myItems.add(new Items(R.drawable.soap5, "MenSoap", "30"));
        myItems.add(new Items(R.drawable.soap6, "FiGaro", "650"));
        myItems.add(new Items(R.drawable.soap7, "WoodLands", "200"));
        myItems.add(new Items(R.drawable.soap8, "Pearls", "59"));
        myItems.add(new Items(R.drawable.soap9, "Ivory", "30"));
        myItems.add(new Items(R.drawable.soap10, "Vivel", "25"));
        myItems.add(new Items(R.drawable.soap11, "First Olive", "15"));
        myItems.add(new Items(R.drawable.soap12, "Spa Soaps", "100"));
        adapter.notifyDataSetChanged();
    }
