...
public class RecycableCansActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recycable_cans);
        listView = (ListView) findViewById(R.id.list);
        setListViewHeader();
        setListViewAdapter();
        createProductListRecycableCans();
    ...
    private void createProductListRecycableCans() {
        myItems.add(new Items(R.drawable.ec1, "Ellaas", "10"));
        myItems.add(new Items(R.drawable.ec2, "CeLLa","50"));
        myItems.add(new Items(R.drawable.ec3, "R.Bottles", "60"));
        myItems.add(new Items(R.drawable.ec4, "MccOTES", "40"));
        myItems.add(new Items(R.drawable.ec5, "Cella", "30"));
