...
public class HairTrimmersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hair_trimmers);
        listView = (ListView) findViewById(R.id.list);
        setListViewHeader();
        setListViewAdapter();
        createProductListHairTrimmers();
    ...
    private void createProductListHairTrimmers() {
        myItems.add(new Items(R.drawable.ht1, "Rossa", "900"));
        myItems.add(new Items(R.drawable.ht2, "CeLLa","200"));
        myItems.add(new Items(R.drawable.ht3, "R.Mount", "600"));
        myItems.add(new Items(R.drawable.ht4, "Zilla", "500"));
        myItems.add(new Items(R.drawable.ht5, "PanaSonic", "300"));
