...
public class UsedBladesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_used_blades);
        listView = (ListView) findViewById(R.id.list);
        setListViewHeader();
        setListViewAdapter();
        createProductListUsedBlades();
    ...
    private void createProductListUsedBlades() {
        myItems.add(new Items(R.drawable.ub1, "Zilla", "1000"));
        myItems.add(new Items(R.drawable.ub2, "Postalla","500"));
        myItems.add(new Items(R.drawable.ub3, "R.Blades", "6000"));
        myItems.add(new Items(R.drawable.ub4, "Zillete", "500"));
        myItems.add(new Items(R.drawable.ub5, "MenShave", "300"));
