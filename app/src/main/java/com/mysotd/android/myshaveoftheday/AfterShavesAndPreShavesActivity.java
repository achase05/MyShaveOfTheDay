...
public class AfterShavesAndPreShavesActivity extends AppCompatActivity {
    EditText itemName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_after_shaves_and_pre_shaves);
        listView = (ListView) findViewById(R.id.list);
        setListViewHeader();
        setListViewAdapter();
        createProductListPreShaves();
    ...
    private void createProductListPreShaves() {
        myItems.add(new Items(R.drawable.ps1, "Ponts", "100"));
        myItems.add(new Items(R.drawable.ps2, "CeLLa","50"));
        myItems.add(new Items(R.drawable.ps3, "ROcky. M", "60"));
        myItems.add(new Items(R.drawable.ps4, "LonTTa", "50"));
        myItems.add(new Items(R.drawable.ps5, "Fair", "30"));
        adapter.notifyDataSetChanged();
    }
